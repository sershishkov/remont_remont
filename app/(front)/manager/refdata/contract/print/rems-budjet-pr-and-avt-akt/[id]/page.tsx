...
import RemsBudjetPrAndAvtAktToPrint from '@/components/documents/formsToPrint/rems-budjet/RemsBudjetPrAndAvtAktToPrint';

export default function RemsBudjetPrAndAvtAktPrint({
  params,
