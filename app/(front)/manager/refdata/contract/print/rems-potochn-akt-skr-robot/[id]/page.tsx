...
import RemsPotochnAktSkrRobotToPrint from '@/components/documents/formsToPrint/rems-potochn/RemsPotochnAktSkrRobotToPrint';

export default function RemsPotochnAktSkrRobotPrint({
  params,
