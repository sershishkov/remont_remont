...
import TehNadzorKoshtToPrint from '@/components/documents/formsToPrint/tehnadzor/TehNadzorKoshtToPrint';

export default function TehNadzorKoshtPrint({ params }: Readonly<ParamsProps>) {
