...
import JkhPismoOtOsbbToPrint from '@/components/documents/formsToPrint/jkh/JkhPismoOtOsbbToPrint';

export default function JkhPismoOtOsbbPrint({ params }: Readonly<ParamsProps>) {
