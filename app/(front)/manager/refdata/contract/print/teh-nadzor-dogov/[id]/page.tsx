...
import TehNadzorDogToPrint from '@/components/documents/formsToPrint/tehnadzor/TehNadzorDogToPrint';

export default function TehNadzorDogovPrint({ params }: Readonly<ParamsProps>) {
