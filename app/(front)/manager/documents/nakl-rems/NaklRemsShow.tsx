...
const arrToShow = (enteredArr: any) => {
  ...
  const transformedArr = localArr.map((currentItem: any) => {
    return {
      _id: currentItem._id,
      nakladnayaRemsNumber1: currentItem.nakladnayaRemsNumber1,
      nakladnayaRemsDate: new Date(
        currentItem.nakladnayaRemsDate
      ).toLocaleDateString('uk-UA', {
        day: '2-digit',
        month: 'long',
        year: 'numeric',
      }),
      totalRemsNaklSum: currentItem.totalRemsNaklSum,
      ourFirm: currentItem.contract.ourFirm.clientShortName,
      clientFirm: currentItem.contract.client.clientShortName,
...
export default function NaklRemsShow({
  currentURL,
  tableHeader,
}: {
    ...
    const filtered_items = await get__all(
      {
        ...
        contract: contract,
        executorFirm1: executorFirm1,
        executorFirm2: executorFirm2,
        executorFirm3: executorFirm3,
